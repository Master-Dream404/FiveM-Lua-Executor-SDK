...
#include <ppltasks.h>
#include <WS2tcpip.h>
#include "..\SDK\HttpClient.h"
#include "..\SDK\client\shared\CrossLibraryInterfaces.h"
...
public:
	...
	virtual void Disconnect(const char* reason = "[Cidia.xyz]") override;
